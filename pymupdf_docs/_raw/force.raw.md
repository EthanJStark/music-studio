...
See _**Operation**_ _>_ _**Modes**_ _>_ _**Mixer**_ to learn more about this feature.
...
See _**Operation**_ _>_ _**General Features**_ _>_ _**Pad Modes**_ _>_ _**Note Mode**_ to
learn more.
...
See _**Operation**_ _>_ _**General Features**_ _>_ _**Pad Modes**_ _>_ _**Step Sequencer**_ to learn more about the other Step Sequencer pad
modes.
...
See _**Operation**_ _>_ _**General Features**_ _>_ _**Pad Modes**_ _>_ _**Step Sequencer**_ and _**Operation**_ _>_ _**Modes**_ _>_ _**Step Sequencer**_ to
...
the standard Drum Note Configuration settings mentioned _**above**_, you
...
Use the **MIDI Input** field to restrict the recorded notes to a set scale. See _**Addenda**_ _>_ _**Updates in Force 3.0.3**_ _>_ _**New**_
_**Features**_ _>_ _**MIDI Input Snap**_ _**to Scale**_ to learn more.
...
in either _**Launch Mode**_ or _**Note Mode**_ .
...
Hold **Shift** and press **Step Seq** to open the **Configuration** window. In addition to the fields mentioned _**above**_ :
...
Hold Shift and press **Step Seq** to open the **Configuration** window. In addition to the fields described _**above**_ :
...
addition to the fields described _**above**_ :
...
Hold **Shift** and press **Step Seq** to open the **Configuration** window. In
addition to the fields mentioned _**above**_ :
...
To learn about editing your tracks to your preference, see the _**Modes**_ _>_ _**Track Edit**_
_**Mode**_ chapter.


An **Audio track** lets you record audio from an external source or by resampling another track to create a clip.
See _**Audio Tracks**_ for more information.
...
mostly for creating drum parts and quickly and easily assigning samples to pads. See _**Drum Tracks**_ for more
information.
...
chromatically with a MIDI keyboard or the Force pads. See _**Keygroup Tracks**_ for more information.


A **plugin track** contains an instance of a plugin through which you can send your track’s MIDI data. See _**Plugin**_
_**Tracks**_ for more information.


A **MIDI track** lets you send your track’s MIDI data to an external MIDI device like a synth or drum machine.
See _**MIDI Tracks**_ for more information.


A **CV track** lets you send your track’s MIDI data to an external device that uses control voltage (CV), like a
synth. See _**CV Tracks**_ for more information.
...
(See _**Modes**_ _>_ _**Pad Color Mode**_ to learn more about editing pad colors).
...
load into the project. (See _**Modes**_ _>_ _**Browser**_ to learn more about using the Browser specifically.)
...
_**Appendix**_ _>_ _**Glossary**_ _>_ _**Filter**_ to learn about this.
...
Mode (see _**Modes**_ _>_ _**Sample Edit Mode**_ _>_ _**Settings**_ ).
...
( **Off** ). See _**Addenda**_ _>_ _**Updates in Force 3.2**_ _>_ _**New Features**_ _>_ _**Menu Editing and Shortcut Panel**_ for more information.
...
1. First, make sure your Force hardware is connected to a network via Wi-Fi or Ethernet. See _**Preferences**_ _>_ _**Wi-Fi**_
or _**Preferences**_ _>_ _**Ethernet**_ to learn how to connect to a network. You will also need access to a web browser.
...
_**Preferences**_ _>_ _**MIDI / Sync**_ for more information.


**Note** : Ableton Link is a new technology that synchronizes beat, phase and tempo of Ableton Live and
Ableton Link-enabled applications over a wireless or wired network. See _**Preferences**_ _>_ _**Wi-Fi**_ or
_**Preferences**_ _>_ _**Ethernet**_ to learn how to connect to a network.
...
See _**Standalone vs. Computer Mode**_ to learn more.
...
**buttons** in the upper-right to jump immediately to those preassigned file paths (see _**Modes**_ _>_ _**Browser**_ to learn how to do this).
...
See _**Macros**_ for more information.


Use the **Learn** button to learn a parameter to a macro control. See
_**Macros**_ for more information.
...
Use the **Action** field to set the type: **Arp**, **Note Repeat**, **Rhythm** and **Pattern** . See _**below**_ for more details about these
...
space. See _**Appendix**_ _>_ _**SATA Drive Installation**_ to learn more about this.
...
**Kits**, **Samples** or **Splice** (see _**below**_ to learn about these content buttons).
...
header again to change the sorting direction. These can be added or removed using the _**Browser Options**_ window.
...
those pre-assigned file paths (see _**below**_ to learn how to assign these file paths).
...
See _**Operation > General Features > Menu > Preferences > Splice**_ for more information on how to connect to your
Splice account.
...
automation data on these tracks in your Arrangement. See _**Addenda > Updates in Force 3.1 > New Features > Bus**_
_**Automation**_ for more information.
...
you activate _**Pad Loop**_ (if the **Sample Play** field in the **LFO Modulation** tab is set to **Note On** ).
...
pad’s layers into one audio sample (see _**here**_ to learn about this). After you flatten the pad, its sample/samples no
...
the later _**Anatomy of an Envelope**_ section to learn about the envelope parameters.
...
switches the loop function between **Forward** and **off** . The loop function is described _**earlier**_ .
...
be set when the slice is assigned to it (see _**Track Edit Mode**_ to learn
...
**To set how the cue playhead behaves**, use the **Settings** window (described _**earlier**_ ).
...
be set when the slices are assigned to them (see _**Track Edit Mode**_ to
...
another project. See the _**Track Edit Mode**_ chapter to learn more about setting a pad to play the entire sample, a specific slice
...
will be set when the slice is assigned to it (see _**Track Edit**_
_**Mode**_ to learn more about the parameters mentioned below):
...
_**General Features**_ _>_ _**Effects**_ .
...
**To edit the recording in Sample Edit Mode** (recommended) **,** tap Edit at the bottom of the screen. See _**Sample Edit**_
_**Mode**_ for more information.
...
threshold slider will work only when **Sync** is **off** (see _**below**_ ).
...
insert effect you have to load to the track before you can use this mode. Learn more about this in _**General**_
_**Features**_ _>_ _**Effects**_ .
...
Macros Mode (formerly _Knobs_ mode) lets you determine what the various hardware controls can be used for
...
1. Select a macro control type by tapping one of the buttons at the bottom of the screen: _**Knob**_, _**Crossfader**_, _**XY**_
_**Pad**_, _**Pad Grid**_ or _**Env Follower**_ . See the following sections for more information on each control type.
...
The screen will show a message, "Learned [ _parameter_ ] to [ _macro control_ ]."
...
Amp Env Hold Layer Sample Pan (1–4) LFO to Filter Velocity to Amp
...
The _Bluetooth_ word mark and logos are registered trademarks owned by Bluetooth SIG, Inc. and any use of such marks
...
This product contains technologies that are used under license. For more information, please visit **[akaipro.com](http://akaipro.com/product-legal)** / **product-**
**[legal](http://akaipro.com/product-legal)** .
...
1. First, make sure your Force hardware is connected to a network via Wi-Fi or Ethernet. See _**Preferences**_ _>_ _**Wi-Fi**_ or

_**Preferences**_ _>_ _**Ethernet**_ to learn how to connect to a network. You will also need access to a web browser.
...
window. In addition to the fields described _**here**_ :
...
1. Download the Akai Network Driver from **[akaipro.com](http://akaipro.com)** and install it by following the directions.
