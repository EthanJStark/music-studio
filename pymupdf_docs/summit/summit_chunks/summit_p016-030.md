# Summit User Guide 1.1 En (Pages 16-30)
...
|elow shows the response of a typical low pass<br>e reduced in volume.|Col2|filter. Freq<br>-off<br>ency|
|---|---|---|
|<br>Cut<br>Frequ|<br>Cut<br>Frequ|<br>Cut<br>Frequ|
||||
||||
||||
|Frequency|Frequency|f point are<br>off<br>ency|
|ce is added, the frequencies around the cut of<br>Cut-<br>Frequ|ce is added, the frequencies around the cut of<br>Cut-<br>Frequ|ce is added, the frequencies around the cut of<br>Cut-<br>Frequ|
||||
||||
|Frequency<br>  he traditional low-pass flter type, there are also high-pas<br> mit, the flter type is selected with the**Shape** switch 58 <br> er is similar to a low-pass flter, but works in the “opposit<br> low the cut-off point which are removed. Frequencies ab<br> ed. When the Filter**Frequency** parameter is set to minim<br> n and no frequencies are removed from the raw Oscillato<br>Cut-off<br>Frequency|Frequency<br>  he traditional low-pass flter type, there are also high-pas<br> mit, the flter type is selected with the**Shape** switch 58 <br> er is similar to a low-pass flter, but works in the “opposit<br> low the cut-off point which are removed. Frequencies ab<br> ed. When the Filter**Frequency** parameter is set to minim<br> n and no frequencies are removed from the raw Oscillato<br>Cut-off<br>Frequency|Frequency<br>  he traditional low-pass flter type, there are also high-pas<br> mit, the flter type is selected with the**Shape** switch 58 <br> er is similar to a low-pass flter, but works in the “opposit<br> low the cut-off point which are removed. Frequencies ab<br> ed. When the Filter**Frequency** parameter is set to minim<br> n and no frequencies are removed from the raw Oscillato<br>Cut-off<br>Frequency|
|er is similar to a low-pass flter, but works in th<br> low the cut-off point which are removed. Freq<br> ed. When the Filter**Frequency** parameter is s<br> n and no frequencies are removed from the ra<br>Cut-off<br>Frequency|er is similar to a low-pass flter, but works in th<br> low the cut-off point which are removed. Freq<br> ed. When the Filter**Frequency** parameter is s<br> n and no frequencies are removed from the ra<br>Cut-off<br>Frequency|er is similar to a low-pass flter, but works in th<br> low the cut-off point which are removed. Freq<br> ed. When the Filter**Frequency** parameter is s<br> n and no frequencies are removed from the ra<br>Cut-off<br>Frequency|
||||
||||
||||
||||
|Frequency<br> ass flter, just a narrow band of frequencies ce<br> uencies above and below the band are remov|Frequency<br> ass flter, just a narrow band of frequencies ce<br> uencies above and below the band are remov||
|Frequency<br> ass flter, just a narrow band of frequencies ce<br> uencies above and below the band are remov|Frequency<br> ass flter, just a narrow band of frequencies ce<br> uencies above and below the band are remov|ntred aroun<br>     ed. It is~~ no~~|
|<br>  of flter and allow all frequencies to pass.<br>Cut-off<br>Frequency|<br>  of flter and allow all frequencies to pass.<br>Cut-off<br>Frequency||
...
|Col1|LPF<br>(f1)|Col3|HPF<br>(f2)|Col5|
|---|---|---|---|---|
||||||
...
|Col1|High pass filter<br>12 dB/oct|Col3|
|---|---|---|
||High pass filter<br>12 dB/oct|High pass filter<br>12 dB/oct|


|Col1|Col2|Col3|
|---|---|---|
|||High pass filt<br>12 dB/oct|
...
|Col1|Col2|Col3|SUSTAIN|Col5|Col6|Col7|
|---|---|---|---|---|---|---|
||||SUSTAIN|TAIN|||
...
Displayed as: `AudioInput`
Initial value: Off
Range of adjustment: Off, PreFilt, PostFilt
...
**Dual Filter Options**
Displayed as: `FltShpMore`
Initial value: LP > HP
Range of adjustment: LP > HP, LP > BP, HP > BP, LP + HP, LP + BP,
...
|Low pass filter<br>12 dB/oct|Col2|
|---|---|
|Frequency<br>Cutoff frequency<br>High pass filter<br>12 dB/oct|Frequency<br>Cutoff frequency<br>High pass filter<br>12 dB/oct|
...
|Col1|LPF<br>12 dB/oct|Col3|LPF<br>12 dB/oct|Col5|
|---|---|---|---|---|
||||||
...
Initial value: On
Range of adjustment: 1 to 126, On
