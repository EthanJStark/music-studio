...
However, that project never got off the ground.

Before we dive back into building THAT project, please help me think outside the box: what tools, workflows, connectivity, and controls for live-tweaking my music might I consider?

The Force by itself has powerful macro midi controls that can have one knob sending
The con to that approach is that the interface is somewhat clunky; we may be able to program friendlier mappings using rPi.
